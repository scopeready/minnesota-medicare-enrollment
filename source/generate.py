...
def build_home():
    home_faqs = [
        ...
        ("When can I enroll in or change my Medicare plan in Minnesota?", "Most people first enroll during their Initial Enrollment Period, the seven months around their 65th birthday. After that, the Annual Election Period runs October 15 to December 7 each year, and the Medicare Advantage Open Enrollment Period runs January 1 to March 31. Medicare Cost plans, where they are sold, accept enrollment year-round, and starting August 1, 2026, Minnesotans aged 65 to 70 can also buy a Medicare supplement without health questions during the Annual Election Period, one time, with a premium surcharge."),
...
- Medicare Cost plans are still sold in 21 counties: Aitkin, Carlton, Cook, Goodhue, Itasca, Kanabec, Koochiching, Lake, Le Sueur, McLeod, Meeker, Mille Lacs, Pine, Pipestone, Rice, Rock, St. Louis, Sibley, Stevens, Traverse, Yellow Medicine (Minnesota Department of Commerce, 2026 Cost plan guide). Sold by Blue Cross Blue Shield of Minnesota and Medica.
- Beginning August 1, 2026, Minnesotans aged 65–70 may buy a Medicare supplement during the Annual Election Period (Oct 15–Dec 7), one time, without medical underwriting; insurers may charge a surcharge starting at 15% in 2026 and rising 5 points a year to 35%.
