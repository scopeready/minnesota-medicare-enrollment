...
SRC_MN_HOUSE = ("Minnesota House Public Information Services: New Laws 2025 (Medicare supplement enrollment, ages 65-70)", "https://www.house.mn.gov/newlaws/consolidated/2025")
SRC_MN_3099 = ("Minnesota Statutes §62A.3099, definitions (open enrollment period, effective Aug 1, 2026)", "https://www.revisor.mn.gov/statutes/cite/62A.3099")
SRC_AGING_101 = ("Minnesota Aging Pathways: Medicare 101 (the 21 Cost plan counties)", "https://mn.gov/aging-pathways/medicare/medicare-101/")
...
dict(slug="medicare-supplement", nav_title="Medicare Supplement plans in Minnesota (Basic &amp; Extended Basic)", crumb="Medicare Supplement", scene="northwoods",
     ...
     keyfacts=["Minnesota does not use the federal Medigap letters A&ndash;N. Under Minnesota Statutes §62A.31, insurers sell a <strong>Basic</strong> plan and an <strong>Extended Basic</strong> plan, and may add optional riders to Basic.",
               ...
               "New for 2026: under Minnesota Statutes §62A.31 as amended in 2025 (effective August 1, 2026), Minnesotans aged 65 through 70 may buy a supplement one time, outside their original six-month window, during a qualifying open-enrollment period &mdash; the Annual Election Period (Oct 15&ndash;Dec 7) or the Medicare Advantage Open Enrollment Period (Jan 1&ndash;Mar 31) &mdash; without medical underwriting or pre-existing-condition limits. Insurers may charge a surcharge above the community rate for as long as the policy is in force: 15% for first use in 2026, 20% in 2027, 25% in 2028, 30% in 2029, 35% from 2030.",
...
<li><strong>New: the ages 65&ndash;70 window.</strong> A 2025 amendment to Minnesota Statutes §62A.31, effective August 1, 2026, lets you buy a supplement <em>one time</em> after your original six-month window has passed, if you are 65 through 70, by applying during the qualifying open-enrollment periods the statute borrows from federal Medicare Advantage rules &mdash; the Annual Election Period (October 15 to December 7) and the Medicare Advantage Open Enrollment Period (January 1 to March 31). The insurer cannot deny you, condition the policy, or impose pre-existing-condition limits based on your health, claims or age. It can charge a surcharge above its community rate, and the surcharge stays with the policy for as long as it is in force: <strong>15%</strong> for first use in 2026, <strong>20%</strong> in 2027, <strong>25%</strong> in 2028, <strong>30%</strong> in 2029 and <strong>35%</strong> from 2030 on. August 1 is the date the law takes effect, not a special August enrollment month. It is a real second chance for people who chose Advantage at 65 and regret it; it is not free.</li>
</ul>
...
<p>People who want maximum freedom to choose doctors and hospitals &mdash; Mayo Clinic without a network question, Fargo or Sioux Falls without a border question &mdash; predictable costs, and coverage that travels. That last point is why so many Minnesota <a href="/snowbirds">snowbirds</a> keep a supplement. The cost is a monthly premium that rises with age and with the carrier&rsquo;s filings.</p>""",
     faqs=[("Does Minnesota have Medigap Plan G or Plan N?", "No. Minnesota, Massachusetts and Wisconsin standardize Medicare supplements their own way. Minnesota sells a Basic plan and an Extended Basic plan, with optional riders on Basic. A Basic plan with the Part A deductible and excess-charge riders is the closest thing to a federal Plan G; copay versions of Basic are the closest thing to Plan N."),
           ...
           ("What is the new Minnesota Medigap rule for 2026?", "Under a 2025 amendment to Minnesota Statutes §62A.31, effective August 1, 2026, people aged 65 through 70 can buy a Medicare supplement one time, outside their original six-month window, by applying during a qualifying open-enrollment period &mdash; the Annual Election Period (October 15 to December 7) or the Medicare Advantage Open Enrollment Period (January 1 to March 31) &mdash; without medical underwriting or pre-existing-condition limits. Insurers may charge a surcharge above the community rate for as long as the policy is in force: 15% for first use in 2026, rising 5 points a year to 35% from 2030. Minnesota Aging Pathways (800-333-2433) can confirm how it applies to you."),
     ...
     sources=[SRC_MN_STATUTE, SRC_MN_3099, SRC_MN_HOUSE, SRC_MN_COMMERCE_MEDIGAP, SRC_MEDIGAP_GOV, SRC_MYMEDIGAP_MN, SRC_CMS], cta="Let&rsquo;s see whether Basic or Extended Basic fits you.", about="Minnesota Medicare supplement insurance"),
...
<p>According to Minnesota Aging Pathways, the state&rsquo;s official Medicare counseling program, and the Minnesota Department of Commerce&rsquo;s annual Cost plan guide, Cost plans are offered for [[YEAR]] in these 21 counties:</p>
""" + COUNTY_LIST_HTML + """
...
<p>People in a Cost-plan county who like a local network and low premiums but travel, split the year between states, or get specialty care in Rochester or the metro; and people who want the option of leaving mid-year without waiting for October. People who never leave their county and want the richest extras may prefer an Advantage plan; people who want no network question at all may prefer a supplement.</p>""",
     ...
     sources=[SRC_AGING_101, SRC_MN_COST_GUIDE, SRC_MEDICARE_OTHER_PLANS, SRC_CMS], cta="In a Cost-plan county? Let&rsquo;s compare all three paths.", about="Medicare Cost plans in Minnesota"),
...
<p><strong>Medigap open enrollment.</strong> Your six-month Medigap open enrollment begins when you are 65 <em>and</em> enrolled in Part B &mdash; during it Minnesota guarantees you the Basic and Extended Basic plans without medical underwriting. Under a law effective August 1, 2026, Minnesota also gives people aged 65 through 70 a one-time chance to buy a supplement without underwriting during the Annual Election Period or the Medicare Advantage Open Enrollment Period, with a premium surcharge of 15% to 35% that lasts as long as the policy; it is a safety net, not a substitute for using the first window well.</p></div>
...
<p>None of this has to be done alone. We help Minnesotans sort through it every day &mdash; clearly, patiently, and at no cost to you. Minnesota Aging Pathways (800-333-2433) offers free, unbiased state counseling as well.</p>""",
     faqs=[("When should I sign up for Medicare if I&rsquo;m turning 65?", "During your Initial Enrollment Period &mdash; the seven months that span the three months before your birthday month, your birthday month, and the three months after. Signing up in the first three months means coverage starts on the first of your birthday month."),
           ...
           ("What is different about turning 65 in Minnesota?", "Your supplement choices are Basic and Extended Basic rather than the lettered plans, Cost plans still exist in 21 counties, and if you later regret an Advantage choice, a 2025 state law (effective August 1, 2026) gives people aged 65 through 70 a one-time chance to buy a supplement without health questions during the Annual Election Period or the Medicare Advantage Open Enrollment Period, with a lasting surcharge of 15% to 35%.")],
     sources=[SRC_CMS, SRC_MN_STATUTE, SRC_MN_HOUSE, SRC_AGING_PATHWAYS], cta="Turning 65? Let&rsquo;s talk it through before the window closes.", about="Medicare enrollment for people turning 65 in Minnesota"),
...
FAQ_PAGE = [
    ...
    ("What is the new Minnesota Medigap rule that took effect in August 2026?", "Under Minnesota Statutes §62A.31 as amended in 2025, people aged 65 through 70 can buy a Medicare supplement one time, outside their original six-month window, by applying during the Annual Election Period (October 15 to December 7) or the Medicare Advantage Open Enrollment Period (January 1 to March 31), without medical underwriting or pre-existing-condition limits. Insurers may charge a surcharge above the community rate for as long as the policy is in force: 15% for first use in 2026, 20% in 2027, 25% in 2028, 30% in 2029, and 35% from 2030. August 1, 2026 is the law&rsquo;s effective date, not an enrollment month."),
    ...
    ("When can I enroll in or change my Medicare plan in Minnesota?", "Your Initial Enrollment Period is the seven months around your 65th birthday. The Annual Election Period runs October 15 to December 7; Medicare Advantage Open Enrollment runs January 1 to March 31. Cost plans accept enrollment year-round where they are sold, life events such as moving counties or losing a plan open Special Enrollment Periods, and since August 2026 people aged 65 through 70 have a one-time chance to buy a supplement without underwriting during those election periods, with a surcharge."),
...
<h2>Licensing</h2>
<p>Darin is a licensed insurance agent in Minnesota and sixteen other states &mdash; Arizona, California, Colorado, Florida, Georgia, Hawaii, Indiana, Nevada, New Mexico, North Carolina, Ohio, South Carolina, Tennessee, Texas, Utah and Washington &mdash; under National Producer Number 18580338, which you can verify with the Minnesota Department of Commerce or the NIPR. The multi-state licence is what lets us follow Minnesota <a href="/snowbirds">snowbirds</a> to Arizona, Florida and Texas.</p>
